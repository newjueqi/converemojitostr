...
*/
	 ...
	 */
	function emoji_to_string($text,$replaceStr="#"){
		
		$text=str_ireplace(array_keys($GLOBALS['emoji_maps']['names']), coverString($replaceStr), coverString($text));
